...
Gets the ip mapping for ipv4 and ipv6 from db-ip.com (lite free version) that is updated once a month.
...
== Webcounter Shortcode ==

	`[webcounter admin=0]`

zählt Seitenzugriffe und füllt Statistikdatenbank, admin=1 zum Auswerten mit Adminrechten
